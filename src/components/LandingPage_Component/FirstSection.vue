    ...
    >
      ...
      >
        ...
        >
          <h1
            v-html="slide.title"
            class="text-2xl sm:text-4xl md:text-[80px] font-bold max-w-full sm:max-w-[600px] md:max-w-[950px] leading-snug md:leading-tight"
          ></h1>
          <a
            :href="slide.buttonLink"
            class="mt-4 sm:mt-6 gap-2.5 flex bg-red-600 hover:bg-red-700 text-white text-base sm:text-xl font-semibold px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow"
          >
